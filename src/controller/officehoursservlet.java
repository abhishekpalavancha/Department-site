...
/**
 * Servlet implementation class officehoursservlet
 */
@WebServlet("/officehoursservlet")
public class officehoursservlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public officehoursservlet() {
        super();
